...
<b>图文混排 , 实现图片文字混排 , 可显示常规链接比如网址,@,#话题# , 手机号 , 邮箱号等 , 可以自定义链接字,设置关键字高亮等功能 . 适用于微博,微信,IM聊天对话等场景 . 例如 : 1. 朋友圈发布内容的表情文字混排 , 网址等链接可点击  , xxx回复了xxx .  2. xxxx发送验证 , "发送验证"可点击 .   3. 搜索内容 , 搜索结果关键字高亮  等等 .  
</p>
</p>
</p>
